        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <ul class="nav col-12 col-md-auto mb-2 justify-content-left mb-md-0">
                <?php if(!isset($_SESSION['user'])){ ?>
                    <li><a href="<?php echo $base_url; ?>/index.php" class="nav-link px-2 link-secondary">Products</a></li>
                    <li><a href="#" class="nav-link px-2 link-dark">FAQs</a></li>
                    <li><a href="#" class="nav-link px-2 link-dark">Contact</a></li>
                <?php }else{ ?>
                    <li><a href="<?php echo $base_url; ?>/index.php" class="nav-link px-2 link-secondary">Products</a></li>
                    <li><a href="<?php echo $base_url; ?>/ordered_products.php" class="nav-link px-2 link-dark">Order Products</a></li>
                    <li><a href="#" class="nav-link px-2 link-dark">FAQs</a></li>
                    <li><a href="#" class="nav-link px-2 link-dark">Contact</a></li>
                <?php } ?>
            </ul>
